  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    ...
    return SynchronousFuture<MaterialLocalizations>(
      KUMaterialLocalizations(
        ...
        fullYearFormat: intl.DateFormat('y', 'ar_SA'),
        mediumDateFormat: intl.DateFormat('EEE, MMM d', 'ar_SA'),
        longDateFormat: intl.DateFormat('EEEE, MMMM d, y', 'ar_SA'),
        yearMonthFormat: intl.DateFormat('MMMM y', 'ar_SA'),
        decimalFormat: intl.NumberFormat('#,##0.###', 'ar_SA'),
        twoDigitZeroPaddedFormat: intl.NumberFormat('00', 'ar_SA'),
      ),
    );
  }
