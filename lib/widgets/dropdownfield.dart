...
class DropDownFieldState extends FormFieldState<String> {
  ...
  List<ListTile> _getChildren(List items) {
  ...
  ListTile _getListTile(value) {
    return ListTile(
      ...
      onTap: () {
        setState(() {
          _effectiveController.text = value.name;
          _handleControllerChanged();
          _showdropdown = false;
          _isSearching = false;
          if (widget.onValueChanged != null) widget.onValueChanged(value.name);
        });
      },
    );
  }
