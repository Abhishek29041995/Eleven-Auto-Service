...
typedef RadioBuilder<T, U> = Widget Function(BuildContext context, List<U> animValues, Function updateState,Services services, T value);
...
class CustomRadio<T, U> extends StatefulWidget {
  ...
  @override
  State<CustomRadio> createState() => _CustomRadioState<T, U>(this.services);
}
...
class _CustomRadioState<T, U> extends State<CustomRadio<T, U>>
  ...
  Services services;
  _CustomRadioState(Services services){
